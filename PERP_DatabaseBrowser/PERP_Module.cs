...
namespace PERP_DatabaseBrowser
{
    ...
    {
        public override string ModuleName => "DBBrowser"; //The module name as listed on clients' windows.
        public override string ModuleFileName => "PERP_DatabaseBrowser.dll"; //The actual filename as compiled and put in the server's "modules" folder
